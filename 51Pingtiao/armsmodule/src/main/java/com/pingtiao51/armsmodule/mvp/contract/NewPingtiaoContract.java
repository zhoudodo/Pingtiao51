...
public interface NewPingtiaoContract{
    ...
    interface View extends IView {
       void sucBanner(List<BannerParentInterface> banners);
       void sucMessage(List<HomeMessageScrollResponse> messages);
       void sucRv(List<PingTiaoSeachResponse> datas);
       void sucShouHuanKuan(ShouHuanKuanResponse data);
       void sucFunction(List<HomePageComResponse> datas);
    }
