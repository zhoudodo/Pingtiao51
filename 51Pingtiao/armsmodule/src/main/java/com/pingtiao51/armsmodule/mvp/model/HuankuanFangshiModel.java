 ...
 */
@ActivityScope
public class HuankuanFangshiModel extends BaseModel implements HuankuanFangshiContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public HuankuanFangshiModel(IRepositoryManager repositoryManager) {
