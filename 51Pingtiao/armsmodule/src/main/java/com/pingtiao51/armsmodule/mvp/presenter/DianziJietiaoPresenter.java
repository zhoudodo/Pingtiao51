 ...
 */
@FragmentScope
public class DianziJietiaoPresenter extends BasePresenter<DianziJietiaoContract.Model, DianziJietiaoContract.View> {
    @Inject
    ...
    @Inject
    public DianziJietiaoPresenter(DianziJietiaoContract.Model model, DianziJietiaoContract.View rootView) {
