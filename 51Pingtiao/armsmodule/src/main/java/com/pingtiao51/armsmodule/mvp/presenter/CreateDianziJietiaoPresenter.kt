 ...
 */
@ActivityScope
class CreateDianziJietiaoPresenter
@Inject
constructor(model: CreateDianziJietiaoContract.Model, rootView: CreateDianziJietiaoContract.View) :
        BasePresenter<CreateDianziJietiaoContract.Model, CreateDianziJietiaoContract.View>(model, rootView) {
    @Inject
