...
public class ZhizhiJietiaoMainActivity extends BaseArmsActivity<ZhizhiJietiaoMainPresenter> implements ZhizhiJietiaoMainContract.View {
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerZhizhiJietiaoMainComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_zhizhi_jietiao_main; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
    ...
    private boolean checkCanCreate() {
        if (TextUtils.isEmpty(zhizhijietiao_jiekuanren.getText().toString())) {
            ArmsUtils.snackbarText("请填写借款人");
            return false;
        }
        if (TextUtils.isEmpty(zhizhijietiao_chujieren.getText().toString())) {
            ArmsUtils.snackbarText("请填写出借人");
            return false;
        }
        if (TextUtils.isEmpty(zhizhijietiao_jiekuanjine.getText().toString())) {
        ...
        jiekuanyongtuQita = xiejietiao_zhizhiyongtutianxie.getText().toString();
        if ("其他".equals(jiekuanyongtuStr) && TextUtils.isEmpty(jiekuanyongtuQita)) {
...
//    DatePickerDialog mDatePickerDialog;
        ...
        switch (view.getId()) {
            ...
            case R.id.paizhao:
                if (selectList.size() <= 0) {
                    ...
                    Intent intent = new Intent(ZhizhiJietiaoMainActivity.this, YulanZhizhiJietiaoActivity.class);
                ...
                break;
            case R.id.choice_yuedinghuankuanriqi_layout:
                if (mDatePickerDialog == null) {
                    ...
                    mDatePickerDialog.setChoiceSureInterface(new CycleDatePickerDialog.ChoiceSureInterface() {
                        ...
                        public void sure(Date date) {
                            ...
                            jiekuanriqiReq = calendar1.get(Calendar.YEAR) + "-"
                                    + (calendar1.get(Calendar.MONTH) + 1) + "-"
                                    + calendar1.get(Calendar.DAY_OF_MONTH);
                            xieshoutiao_jingshouriqi_tv.setText(
                ...
                break;
            case R.id.choice_zhizhijiekuan_layout:
                if (mJiekuanyongtuDialog == null) {
                    ...
                    mJiekuanyongtuDialog.setmJiekuanyongtuLis(new JiekuanyongtuDialog.JiekuanyongtuLis() {
                        ...
                        public void sure(String jiekuanyongtu) {
                            ...
                            xiejietiao_zhizhiyongtu.setText(jiekuanyongtuStr);
                            if (jiekuanyongtuStr.equals("其他")) {
                                findViewById(R.id.jiekuanyongtu_qita2).setVisibility(View.VISIBLE);
                            } else {
                                jiekuanyongtuStr = jiekuanyongtu;
                                findViewById(R.id.jiekuanyongtu_qita2).setVisibility(View.GONE);
                            }
                        }
                    });
                }
    ...
    private void paizhaoQu() {
        ...
        PictureSelector.create(ZhizhiJietiaoMainActivity.this)
...
//                        .videoMinSecond(10)
    ...
    private void createZhizhiJietiao(){
        jiekuanyongtuQita = xiejietiao_zhizhiyongtutianxie.getText().toString();
        mPresenter.beifenZhizhiJietiao(
                zhizhijietiao_jiekuanjine.getText().toString(),
                zhizhijietiao_jiekuanren.getText().toString(),
                xieshoutiao_beizhu_edit.getText().toString(),
                zhizhijietiao_chujieren.getText().toString(),
                "其他".equals(jiekuanyongtuStr)?jiekuanyongtuQita:jiekuanyongtuStr,
                jiekuanriqiReq,
                urls
        );
    }
