 ...
 */
@FragmentScope
public class DianziShoutiaoModel extends BaseModel implements DianziShoutiaoContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public DianziShoutiaoModel(IRepositoryManager repositoryManager) {
