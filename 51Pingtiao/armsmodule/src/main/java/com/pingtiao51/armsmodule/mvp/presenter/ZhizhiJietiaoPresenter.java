 ...
 */
@FragmentScope
public class ZhizhiJietiaoPresenter extends BasePresenter<ZhizhiJietiaoContract.Model, ZhizhiJietiaoContract.View> {
    @Inject
    ...
    @Inject
    public ZhizhiJietiaoPresenter(ZhizhiJietiaoContract.Model model, ZhizhiJietiaoContract.View rootView) {
