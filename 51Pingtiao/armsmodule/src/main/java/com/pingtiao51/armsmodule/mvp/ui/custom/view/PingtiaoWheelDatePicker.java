...
public class PingtiaoWheelDatePicker extends WheelDatePicker implements  IDebug, IWheelPicker, IWheelDatePicker, IWheelYearPicker, IWheelMonthPicker,
    ...
    public PingtiaoWheelDatePicker(Context context, AttributeSet attrs) {
        ...
        mPickerYear = (WheelYearPicker) findViewById(com.aigestudio.wheelpicker.R.id.wheel_date_picker_year);
        mPickerMonth = (WheelMonthPicker) findViewById(com.aigestudio.wheelpicker.R.id.wheel_date_picker_month);
        mPickerDay = (WheelDayPicker) findViewById(com.aigestudio.wheelpicker.R.id.wheel_date_picker_day);
        ...
        mTVYear = (TextView) findViewById(com.aigestudio.wheelpicker.R.id.wheel_date_picker_year_tv);
        mTVMonth = (TextView) findViewById(com.aigestudio.wheelpicker.R.id.wheel_date_picker_month_tv);
        mTVDay = (TextView) findViewById(com.aigestudio.wheelpicker.R.id.wheel_date_picker_day_tv);
    ...
    public void onItemSelected(WheelPicker picker, Object data, int position) {
        if (picker.getId() == com.aigestudio.wheelpicker.R.id.wheel_date_picker_year) {
            mYear = (int) data;
            mPickerDay.setYear(mYear);
        } else if (picker.getId() == com.aigestudio.wheelpicker.R.id.wheel_date_picker_month) {
            mMonth = (int) data;
