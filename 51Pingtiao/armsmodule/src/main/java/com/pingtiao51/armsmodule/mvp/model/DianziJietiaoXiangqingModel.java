 ...
 */
@ActivityScope
public class DianziJietiaoXiangqingModel extends BaseModel implements DianziJietiaoXiangqingContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public DianziJietiaoXiangqingModel(IRepositoryManager repositoryManager) {
