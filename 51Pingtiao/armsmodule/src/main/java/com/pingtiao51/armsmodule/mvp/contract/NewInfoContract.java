...
public interface NewInfoContract {
    ...
    interface View extends IView {
        public void onSucBanner(NewsInfoResponse banners);
        public void onSucRefreshNewsList(NewsInfoResponse lists);
        public void onSucLoadMore(NewsInfoResponse lists);
    }
