 ...
 */
@FragmentScope
public class DianziShoutiaoPresenter extends BasePresenter<DianziShoutiaoContract.Model, DianziShoutiaoContract.View> {
    @Inject
    ...
    @Inject
    public DianziShoutiaoPresenter(DianziShoutiaoContract.Model model, DianziShoutiaoContract.View rootView) {
