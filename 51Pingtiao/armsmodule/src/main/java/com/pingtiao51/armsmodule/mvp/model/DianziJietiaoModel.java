 ...
 */
@FragmentScope
public class DianziJietiaoModel extends BaseModel implements DianziJietiaoContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public DianziJietiaoModel(IRepositoryManager repositoryManager) {
