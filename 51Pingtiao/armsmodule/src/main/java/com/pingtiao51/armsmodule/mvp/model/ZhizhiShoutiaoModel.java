 ...
 */
@FragmentScope
public class ZhizhiShoutiaoModel extends BaseModel implements ZhizhiShoutiaoContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public ZhizhiShoutiaoModel(IRepositoryManager repositoryManager) {
