 ...
 */
@FragmentScope
public class CopyPingtiaoPresenter extends BasePresenter<CopyPingtiaoContract.Model, CopyPingtiaoContract.View> {
    @Inject
    ...
    @Inject
    public CopyPingtiaoPresenter(CopyPingtiaoContract.Model model, CopyPingtiaoContract.View rootView) {
