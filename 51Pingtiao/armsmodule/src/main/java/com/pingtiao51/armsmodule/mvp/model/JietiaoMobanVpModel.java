 ...
 */
@ActivityScope
public class JietiaoMobanVpModel extends BaseModel implements JietiaoMobanVpContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public JietiaoMobanVpModel(IRepositoryManager repositoryManager) {
