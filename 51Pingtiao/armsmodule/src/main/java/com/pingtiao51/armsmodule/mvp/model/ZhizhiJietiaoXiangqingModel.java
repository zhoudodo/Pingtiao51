 ...
 */
@ActivityScope
public class ZhizhiJietiaoXiangqingModel extends BaseModel implements ZhizhiJietiaoXiangqingContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public ZhizhiJietiaoXiangqingModel(IRepositoryManager repositoryManager) {
