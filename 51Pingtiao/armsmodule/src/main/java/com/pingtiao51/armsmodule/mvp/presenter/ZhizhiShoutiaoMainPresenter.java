 ...
 */
@ActivityScope
public class ZhizhiShoutiaoMainPresenter extends BasePresenter<ZhizhiShoutiaoMainContract.Model, ZhizhiShoutiaoMainContract.View> {
    @Inject
    ...
    @Inject
    public ZhizhiShoutiaoMainPresenter(ZhizhiShoutiaoMainContract.Model model, ZhizhiShoutiaoMainContract.View rootView) {
    ...
    public void beifenZhizhiJietiao(
        ...
        mModel.beifenZhizhiShoutiao(amount,
                borrower,
                comment,
                lender,
                repaymentDate,
                ...
                .doOnSubscribe(new Consumer<Disposable>() {
                    ...
                    public void accept(Disposable disposable) throws Exception {
                        ((BaseArmsActivity)mRootView).showLoading("正在提交纸质收条，请稍后...");
                    }
                })
